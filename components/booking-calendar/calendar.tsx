...
export const Calendar: React.FC<CalendarProps> = ({
  ...
  }, [hasIntersected, currentDate, eventTypeId, fetchMonthSlots]);

  // Refresh selected-day data when timezone or month data changes.
  useEffect(() => {
    if (!userTimezone || !selectedDate) return;
    fetchSlots(selectedDate);
  }, [userTimezone, selectedDate, monthSlots, fetchSlots]);
